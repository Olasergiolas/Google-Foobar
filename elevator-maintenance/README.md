...
====================
## Explanation
In order to solve this challenge, I have used the quicksort algorithm to sort more efficiently the version numbers stored in the array. The logic to compare two versions is rather simple, converting the version number to an array of integers first, to be able to compare each series individually (major, minor and revision).
